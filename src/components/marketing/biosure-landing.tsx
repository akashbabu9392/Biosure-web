  ...
  return (
    <div className={themeClass}>
      ...
      <main className="pt-16">
        ...
        {/* ROI */}
        {showRoi ? (
          <section id="roi" className="bg-[var(--bg2)] border-y border-[color:var(--border)] px-6 py-20">
            <div className="mx-auto max-w-[1100px]">
              <Reveal delay={0.05}>
                <div className="text-[color:var(--accent)] text-[.75rem] font-semibold uppercase tracking-[.8px] inline-flex items-center gap-2">
                  <MarketingIcon
                    id={biosureLanding.roi.badge.iconId}
                    className="h-4 w-4"
                  />
              ...
              <div className="mt-14 grid gap-10 lg:grid-cols-2">
                <div className="space-y-4">
                  <Reveal delay={0.1}>
                    <div className="overflow-hidden rounded-xl border border-[color:var(--border)]">
                      <div className="grid grid-cols-[1.4fr_1fr_1fr] bg-[rgba(255,255,255,0.03)] border-b border-[color:var(--border)]">
                      ...
                      {biosureLanding.roi.table.rows.map((r) => (
                        <div
                          key={r.label}
                          className="grid grid-cols-[1.4fr_1fr_1fr] border-b border-[color:var(--border)] last:border-b-0"
                        >
                          <div className="p-4 text-left text-[.8rem] text-[color:var(--muted)] pl-5">
                            {r.label}
                            {r.meta ? (
                              <div className="mt-1 text-[.7rem] text-[rgba(255,255,255,0.25)]">
                                {r.meta}
                              </div>
                            ) : null}
                          </div>
                          <div
                            className={[
                              ...
                              r.manualType === "boldManual" ? "text-[color:var(--text)] font-bold" : "",
                            ].join(" ")}
                          >
                            {r.manual}
                          </div>
                    ...
                    <div className="mt-2 text-[.7rem] text-[rgba(255,255,255,0.2)]">
                ...
                <div className="space-y-6">
                  <Reveal delay={0.15}>
                    <div className="rounded-xl border border-[rgba(0,194,168,0.2)] bg-[linear-gradient(135deg,rgba(0,194,168,0.08),rgba(0,112,243,0.05))] p-6">
                      <div className="text-[3rem] font-[var(--font-serif)] leading-none text-[color:var(--accent)]">
                        {biosureLanding.roi.callout.number}
                      </div>
                      <div className="mt-1 text-[.85rem] leading-[1.5] text-[color:var(--muted)]">
                    ...
                    {biosureLanding.roi.bullets.map((b, idx) => (
                      <Reveal key={b.title} delay={idx * 0.06 + 0.1} y={16}>
                        <div className="flex items-start gap-4">
                          <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg border border-[rgba(0,194,168,0.2)] bg-[rgba(0,194,168,0.1)] text-[.9rem]">
                            <RoiIcon
                              id={b.iconId}
                          ...
                          <div>
                            ...
                            <div className="text-[.78rem] text-[color:var(--muted)]">
                              {b.desc}
                            </div>
                          </div>
                        </div>
        ...
        >
          <div className="mx-auto max-w-[1100px]">
            <Reveal delay={0.05}>
              <div className="mx-auto max-w-[600px] text-center">
                <div className="mx-auto inline-flex items-center rounded-full bg-[rgba(124,58,237,0.10)] px-3 py-1 text-[.7rem] font-semibold text-[#7c3aed]">
        ...
        <section className="relative overflow-hidden px-6 pb-24 pt-32 text-center">
          <div className="pointer-events-none absolute left-1/2 top-1/2 h-[500px] w-[700px] translate-x-[-50%] translate-y-[-50%] rounded-full bg-[radial-gradient(ellipse,rgba(0,194,168,0.12)_0%,transparent_70%)]" />
          <div className="relative mx-auto max-w-[700px]">
            <Reveal delay={0.1}>
              <h2 className="font-[var(--font-serif)] text-[clamp(2.2rem,5vw,4rem)] leading-[1.1] tracking-[-1px]">
                {biosureLanding.cta.titleBefore} <br />
                <em className="italic text-[color:var(--accent)]">{biosureLanding.cta.titleEm}</em>
              </h2>
            </Reveal>
            <Reveal delay={0.15}>
              <p className="mx-auto mt-5 max-w-[480px] text-[.95rem] leading-[1.7] text-[color:var(--muted)]">
            ...
            <Reveal delay={0.2}>
              <div className="mt-10 flex flex-wrap justify-center gap-3">
                ...
                <Link
                  href="#"
                  className="inline-flex items-center justify-center rounded-xl border border-[rgba(255,255,255,0.14)] bg-[rgba(255,255,255,0.03)] px-6 py-3 text-[.95rem] font-medium text-[color:var(--text)] transition hover:bg-[rgba(255,255,255,0.07)]"
                >
            ...
            <Reveal delay={0.25}>
              <div className="mt-8 text-[.78rem] text-[rgba(255,255,255,0.25)]">
